...
import com.jasoncsullivan.mymaps.models.MapsAdapter
import com.jasoncsullivan.mymaps.models.Place
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showAlertDialog() {
        ...
        val dialog = AlertDialog.Builder(this).setTitle("Map title").setView(mapFormView).setNegativeButton("Cancel", null).setPositiveButton("OK", null).show()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        Log.i(TAG, "ouch $requestCode $resultCode needs ${Activity.RESULT_OK}")
